package com.company.app.client.api;

import com.company.app.client.config.RestClientProperties;
import com.company.app.client.web.dtos.ProductDto;
import com.company.app.client.web.dtos.RestPageImpl;
...
public class ProductRestClient {
    ...
    public Page<ProductDto> list(Pageable pageable) {
        ParameterizedTypeReference<RestPageImpl<ProductDto>> ptr =
